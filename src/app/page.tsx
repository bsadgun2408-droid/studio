...
export default function DashboardPage() {
  ...
  const studyMaterialSections = [
    ...
    { key: 'pyqs', title: 'Previous Year Questions', icon: BookOpenCheck, color: 'text-teal-500' },
  ];
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription className="space-y-4 text-left">
                          <div>
                            <div>1. This content is generated by artificial intelligence using the Gemini API. We do not guarantee the accuracy, completeness, or legality of the information or content produced by the AI. The responsibility for ensuring that any AI-generated content does not violate copyright laws rests solely with the user. The owner/developer is not liable for any copyright or legal issues resulting from AI outputs.</div>
                            <div>2. The content produced here is automatically generated by AI technology (Gemini API). All outputs are provided as-is for informational purposes only. We disclaim any responsibility or liability for any copyright infringement or legal issues caused by user reliance on this content.</div>
                            <div>3. This application uses AI services to create content. While efforts are made to ensure quality and legality, the AI may inadvertently generate or reproduce copyrighted material. Users are fully responsible for how they use or share AI-generated content, and must verify its legality. The owner does not assume any liability for the use of AI-generated material.</div>
                          </div>
